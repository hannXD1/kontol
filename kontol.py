...
def logo():
    print("""
\033[44;1mWelcome To My Scrpt\033[00;1m
\033[34;1m（\033[35;1m；\033[36;1m￣\033[32;1mェ\033[36;1m￣\033[34;1m）\033[32;1mTema Linux
  \033[37;1m[\033[32;1mAuthor:Mr-S4NTUY\033[37;1m]
\033[37;1m[\033[32;1mTUTORIAL ANDROID\033[37;1m]
""")
...
clear
echo "
\033[37;1m[\033[41;1mTERMUX\033[00;1m\033[37;1m]
\033[37;1m[\033[44;1mHann-XD\033[00;1m\033[37;1m]"
echo ""
PS1='\n\[\033[0;92m\]%s\[\033[00m\]X\[\033[0;92m\]MENCOBA\[\033[0;96m\]:${PWD/*\//}\[\033[00m\](\#)\[\033[0;92m\]~#\[\033[00m\] '
"""% nama)
    tema.close()
...
def kembali():
    os.system("clear")
    exit("\033[34;1mJangan Lupa Subscribe Channel TUTORIAL ANDROID:)")
main()
